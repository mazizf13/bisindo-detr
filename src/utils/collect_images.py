...
class CaptureImages(): 
    ...
    def capture(self, class_name: str) -> bool:     
        try: 
            ...
            image = cv2.putText(frame, f'Capturing {class_name}', (0,100), 
                                cv2.FONT_HERSHEY_DUPLEX, 3, (0,0,0), 2, cv2.LINE_AA)
...
if __name__ == '__main__': 
    cap = CaptureImages('./data/collect_images/apr', classes, 0)
    cap.run(num_images=50, sleep_time=2.0)
