...
class SignLanguageLogger:
    ...
    def realtime(self, message: str, **kwargs):
        ...
        # self.logger.info(f"[realtime][CAPTURE] {message}")
    ...
    def print_banner(self):
        """Print the Bisindo Detection project banner."""
        banner = """                                          
     _____ _       _         _    _____     _     
...
╔═══════════════════════════════════════════════════════════╗
║  🤟 Deteksi Alfabet BISINDO Menggunakan DETR              ║
║  🎯 Implementasi Real-time Deteksi Alfabet BISINDO        ║
